...
function M:newUI( options )
	...
	local useFontBold
	if "Win" == system.getInfo( "platformName" ) then useFontBold = native.systemFontBold
	elseif "Android" == system.getInfo( "platformName" ) then useFontBold = native.systemFontBold
	else useFontBold = "HelveticaNeue"
	end
	self.appFontBold = useFontBold
	-- Place Corona title
